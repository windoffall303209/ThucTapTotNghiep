-- T?p l?nh SQL database schema kh?i t?o ho?c n?p d? li?u cho c? s? d? li?u c?a ?ng d?ng.
...
-- C?u l?nh SQL `DROP` th?c hi?n m?t b??c thay ??i ho?c truy v?n d? li?u; c?n ki?m tra ?i?u ki?n v? ph?m vi t?c ??ng tr??c khi ch?y.
...
-- C?u l?nh SQL `SET` th?c hi?n m?t b??c thay ??i ho?c truy v?n d? li?u; c?n ki?m tra ?i?u ki?n v? ph?m vi t?c ??ng tr??c khi ch?y.
