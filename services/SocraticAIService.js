// Dịch vụ socratic aiservice đóng gói nghiệp vụ chính và phối hợp các lớp dữ liệu hoặc tích hợp bên ngoài.
const SystemSetting = require('../models/SystemSetting');
const { execFile } = require('child_process');
const { assertAllowedProviderBaseUrl } = require('../utils/outboundUrlPolicy');

// Hàm explainTheory dùng để thực hiện logic nghiệp vụ chính và trả kết quả cho luồng gọi; cần bảo toàn hợp đồng đầu vào và giá trị trả về của luồng gọi.
...
// Hàm explainExercise dùng để thực hiện logic nghiệp vụ chính và trả kết quả cho luồng gọi; cần bảo toàn hợp đồng đầu vào và giá trị trả về của luồng gọi.
...
// Hàm buildKnownExerciseReply dùng để xây dựng kết quả từ các nguồn dữ liệu và quy tắc liên quan; cần bảo toàn hợp đồng đầu vào và giá trị trả về của luồng gọi.
...
// Hàm isSetNotationCountQuestion dùng để cập nhật trạng thái hoặc dữ liệu theo quy tắc nghiệp vụ; cần bảo toàn hợp đồng đầu vào và giá trị trả về của luồng gọi.
...
// Hàm getProviderPriority dùng để lấy dữ liệu và xử lý trường hợp không tìm thấy kết quả; cần bảo toàn hợp đồng đầu vào và giá trị trả về của luồng gọi.
...
// Hàm addProviderIfAvailable dùng để tạo bản ghi hoặc tài nguyên mới sau khi kiểm tra đầu vào; cần bảo toàn hợp đồng đầu vào và giá trị trả về của luồng gọi.
...
// Hàm callOpenAICompatible dùng để thực hiện logic nghiệp vụ chính và trả kết quả cho luồng gọi; cần bảo toàn hợp đồng đầu vào và giá trị trả về của luồng gọi.
...
// Hàm callGemini dùng để thực hiện logic nghiệp vụ chính và trả kết quả cho luồng gọi; cần bảo toàn hợp đồng đầu vào và giá trị trả về của luồng gọi.
...
// Hàm callGeminiCli dùng để thực hiện logic nghiệp vụ chính và trả kết quả cho luồng gọi; cần bảo toàn hợp đồng đầu vào và giá trị trả về của luồng gọi.
...
// Hàm formatChoices dùng để chuyển đổi dữ liệu sang định dạng phù hợp; cần bảo toàn hợp đồng đầu vào và giá trị trả về của luồng gọi.
...
// Hàm formatChatHistory dùng để chuyển đổi dữ liệu sang định dạng phù hợp; cần bảo toàn hợp đồng đầu vào và giá trị trả về của luồng gọi.
...
// Hàm cleanTutorReply dùng để chuẩn hóa và làm sạch dữ liệu đầu vào; cần bảo toàn hợp đồng đầu vào và giá trị trả về của luồng gọi.
...
// Hàm buildTheoryFallback dùng để xây dựng kết quả từ các nguồn dữ liệu và quy tắc liên quan; cần bảo toàn hợp đồng đầu vào và giá trị trả về của luồng gọi.
...
// Hàm buildExerciseFallback dùng để xây dựng kết quả từ các nguồn dữ liệu và quy tắc liên quan; cần bảo toàn hợp đồng đầu vào và giá trị trả về của luồng gọi.
