// Bộ kiểm thử question supplement import.test xác minh hành vi và các điều kiện biên quan trọng của hệ thống.
...
// Hàm validQuestion dùng để thực hiện logic nghiệp vụ chính và trả kết quả cho luồng gọi; cần bảo toàn hợp đồng đầu vào và giá trị trả về của luồng gọi.
...
// Hàm validScope dùng để thực hiện logic nghiệp vụ chính và trả kết quả cho luồng gọi; cần bảo toàn hợp đồng đầu vào và giá trị trả về của luồng gọi.
function validScope() {
  return {
